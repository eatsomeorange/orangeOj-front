    ...
    <a-form :model="form" label-align="left">
      ...
      <a-form-item label="判题配置" :content-flex="false" :merge-props="false">
        <a-space direction="vertical" style="min-width: 480px">
          <a-form-item field="judgeConfig.timeLimit" label="时间限制" no-style>
            <a-input-number
          ...
          <a-form-item field="judgeConfig.stackLimit" label="堆栈限制" no-style>
            <a-input-number
